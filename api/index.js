...
module.exports = async (req, res) => {
    ...
    // 🔐 Binance Keys aur API Engine Configurations (Fixed Space and URL)
    const BINANCE_API_KEY = "1pusEFiom6jcibfG6eWtd0wlf216c75kT3FHquCNcK9tDA2ZE1D1mVI7Dr2p6ydE";
    const BINANCE_SECRET_KEY = "abqSlhmVwc0YZG4RPNIfB4FivLKFCvTmbVbgpu57AcVHXJ0pg20sdJbEKbDxJsSv";
    ...
    if (req.method === 'GET') {
        try {
            ...
            return res.status(200).json({ 
                status: "Offline/Setup Issue", 
                balance: "0.00", 
                trend: 1, 
                ts4: 0,
                error_details: err.response ? JSON.stringify(err.response.data) : err.message 
            });
        }
    }
